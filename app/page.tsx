...
const examples = [
  "Can I edit a scheduled case in the OR Schedule Board?",
  "What is LiveData PeriOp Planner used for?",
  "How do I schedule a new case in PeriOp Planner?",
];
